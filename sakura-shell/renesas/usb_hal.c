...
USB_ERR USBHAL_Disable(void)
{
    ...
    /*Stop the selected USB module*/
        ...
        MSTP_USB0        = 1;      /* Enable module-stop state for USB Module 0. */
...
static void HW_Init_Module0(void)
{
    ...
    MPC.P32PFS.BIT.PSEL = 1; /* Use Port 32 as peripheral. */
    MPC.P34PFS.BIT.PSEL = 1; /* Use Port 34 as peripheral. */
...
#error "no target"
    ...
    ICU.IR[IR_USB0_USBI0].BIT.IR = 0;
        ...
        SYSTEM.PRCR.WORD = 0xa502; /* Enable writing to MSTP registers. */
        MSTP_USB0        = 0;      /* Disable module-stop state for USB Module 0. */
        SYSTEM.PRCR.WORD = 0xa500; /* Disable writing to MSTP registers. */
    #endif
}
/**********************************************************************
